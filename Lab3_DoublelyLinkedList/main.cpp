...
void testImportDataFile()
{
    ...
    else
    {
        ...
        cout << "Going to sort list. ";
        system("pause");
        List.mergeSort(List, 0);

        bool forwards = true;
        cout << "Going to traverse all imported items forwards. ";
        system("pause");

        Node<string> *nodePtr = List.head;
        List.showList(forwards, nodePtr, 0);
        cout << "\t Current size: " << List.getCurrentSize() << endl;

        forwards = false;
        cout << "Going to traverse all imported items backwards. ";
        system("pause");
        nodePtr = List.tail;
        List.showList(forwards, nodePtr, 0);
        cout << "\t Current size: " << List.getCurrentSize() << endl;
...
void menu()
{
    ...
    cout << "*  + Convert Lab1's single linked list to be a doubly linked list                              *" << endl;
    cout << "*  + Inport UProducts.csv to the doubly linked list                                            *" << endl;
    cout << "*  + Perform sorting: Bubble Sort, Selection Sort, Merge sort and Quick Sort                   *" << endl;
    cout << "*  + Traverse list forwards and backwards                                                      *" << endl;
    cout << "*                                                                                              *" << endl;
    cout << "* Choices:                                                                                     *" << endl;
    ...
    cout << "*  6) Traverse list forwards                                                                   *" << endl;
    cout << "*  7) Traverse list backwards                                                                  *" << endl;
    cout << "*  8) Get current size                                                                         *" << endl;
    cout << "************************************************************************************************" << endl;
}
...
void main()
{
    ...
    do
    {
        cout << "Please enter your choice [0-8]:";
        cin >> input;
        switch (input)
        {
        case 1:
        ...
        case 2:
            iterator_count = List.bubbleSort();
            List.sorted = true;
            cout << "Bubble Sort finished (times: " << iterator_count << ")." << endl;
            break;

        case 3:
            iterator_count = List.selectionSort();
            List.sorted = true;
            cout << "Selection Sort finished (times: " << iterator_count << ")." << endl;
            break;

        case 4:
            iterator_count = List.mergeSort(List, 0);
            List.sorted = true;
            cout << "Merge Sort finished (times: " << iterator_count << ")." << endl;
            break;

        case 5:
            iterator_count = List.quickSort(List, 0);
            List.sorted = true;
            cout << "Quick Sort finished (times: " << iterator_count << ")." << endl;
            break;
